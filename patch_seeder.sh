...
object DatabaseSeeder {
    fun seedDatabase(db: CrescentDatabase) {
        val users = listOf(
            UserEntity("U1", "Anilesh Demo", "student@crescentconnect.demo", "Student@123", "STUDENT", "DEMO2026001", "MCA", "Computer Applications", "II", "A", null, "2023-2024", null, true),
            UserEntity("U2", "Dr. Kumar Demo", "staff@crescentconnect.demo", "Staff@123", "STAFF", null, null, "Computer Applications", null, null, "Assistant Professor", "2023-2024", null, true),
            UserEntity("U3", "System Administrator", "admin@crescentconnect.demo", "Admin@123", "ADMIN", null, null, null, null, null, "System Admin", null, null, true),
            UserEntity("U4", "CR Student Demo", "cr@crescentconnect.demo", "CR@123", "CR", "DEMO2026002", "MCA", "Computer Applications", "II", "A", null, "2023-2024", null, true),
            UserEntity("U5", "Sarah Ahmed", "sarah@student.crescent.edu", "password", "STUDENT", "220071601006", "MCA", "Computer Applications", "Semester IV", "A", null, "2023-2024", null, true),
            UserEntity("U6", "Dr. Priya Demo", "advisor@crescentconnect.demo", "Advisor@123", "CLASS_ADVISER", null, null, "Computer Applications", null, null, "Assistant Professor", "2023-2024", null, true)
        )
        ...
        val crPermissions = listOf(
            CRPermissionEntity("P1", "U4", "C2", "2026-08-30", 3, System.currentTimeMillis(), System.currentTimeMillis() + 86400000, "U2", true)
        )
