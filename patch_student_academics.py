with open("app/src/main/java/com/example/ui/dashboard/StudentAcademicsTab.kt", "r") as f:
    content = f.read()

# Make it look like a very professional academic dashboard
...
with open("app/src/main/java/com/example/ui/dashboard/StudentAcademicsTab.kt", "w") as f:
    f.write(new_ui)
